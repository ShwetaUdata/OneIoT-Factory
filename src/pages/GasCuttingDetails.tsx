            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-3xl font-bold text-white">Gas cutting: GP-31 •</h1>
                ...
                <p className="text-s text-slate-400 mt-1">Gas Cutting Line • Production Analytics Dashboard</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Button
