            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-3xl font-bold text-white">Shot Blasting: GP-31 •</h1>
                ...
                <p className="text-s text-slate-400 mt-1">Surface Preparation Line • Production Analytics Dashboard</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Button
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 relative -top-4">
                ...
                <div>
                  <CardTitle className="text-lg text-white">Shot Blasting: GP-31</CardTitle>
                  <span
                    className={`text-sm ${
                      selectedPeriod === "24h"
                        ? "text-green-500"
